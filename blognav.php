...
<head>
  ...
  <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.2.1/dist/css/bootstrap.min.css" rel="stylesheet"
    ...
    <link rel="stylesheet" href="blognav.css">
...
<body>
  <header>
    ...
    <nav class="navbar navbar-expand-lg navbar-light p-3 fixed-top" id="mainNav">
          ...
          <div class=" collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav ms-auto ">
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink" style="background: pink; opacity: 50%;">
                  <li><a class="dropdown-item" href="view.php">Our Blogs</a></li>
                  <li><a class="dropdown-item" href="create.php">Create a Blog Post</a></li>
                  <li><a class="dropdown-item" href="blogform.php">Contact us</a></li>
                </ul>
              </li>
              <!-- <li class="nav-item dropdown">
                <a class="nav-link mx-2" href="view.php" target="_blank">Blogs</a>
              ...
              <li class="nav-item">
                <a class="nav-link mx-2" href="blogform.php">
                  Contact Us
                </a>
                <!-- <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                  <li><a class="dropdown-item" href="#">Blog</a></li>
      ...
      <div id="hero" style="background:url('coupleSilhouette.jpg') no-repeat;background-size:cover;background-position:top center">
  ...
  <div class="row no-gutters">
          ...
          <div class="contact-box ml-3">
            ...
            <form class="mt-4">
              <div class="row">
                ...
                <div class="col-lg-12">
                  <button type="submit" class="btn btn-danger mt-3 text-white border-0 px-3 py-2"><span> SUBMIT</span></button>
                </div>
              </div>
            </form>
          </div>
    ...
    <!-- <div class="container-fluid" style="height: 400px; margin-top: 10px;">
    <div  id="hero" style="background:url('coupleSilhouette.jpg') no-repeat;background-size:cover;background-position:top center">
  ...
  <footer>
    ...
    <div class=" my-2">
        ...
        <footer class="text-black text-center text-lg-start" style="background-color: pink;">
          <!-- Grid container -->
          ...
          <div class="text-center p-3" style="background-color: rgba(0, 0, 0, 0.2);">
            © 2023 Copyright:
            <a class="text-black" href="#">FrankyBlog.com</a>
          </div>
          <!-- Copyright -->
        </footer>
